...
def PrepareLibrariesAndDatasets():
  ...
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet8_WHU.pt  https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/EYZL5xnBYutBvbmw5LITkF8BPcjFWxvPpz7f6XdG2ER-zg?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet32_WHU.pt https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/EQ55tvZXi49DmOlEIwezxVcB9LoMQSevNIQvbaMs3z4DYg?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet64_WHU.pt https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/Ec0Ait83aZtFvMKdHJ1LTqIBViukYf5L5ppqrAgTfgz1zQ?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet8_LEVIR.pt  https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/EWqQp2nWIiNIpZlf17NQMToBQRLgaWSFaZoy-6aaSbupbg?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet32_LEVIR.pt https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/EaudSyHuOwpLuNCGdP9FiToB0tgQ50ZTLZykGouNk_Y0BQ?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet64_LEVIR.pt https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/ESPVouHxSLlEn9s5Lw9sX1kBg_VEJOjoWHGqAnqYoAxPdQ?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet8_DSIFN.pt  https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/EXKDGt0CI0NGp4bDvbAxeB8Bq4NZlC34-c_siXZ4GC9SkQ?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet32_DSIFN.pt https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/EdHNCK09KcVGu-z6JD1AFmABG5EIWAeMSof6Uy7zxSfKLg?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet64_DSIFN.pt https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/EW5Jjd9Gn0hDj8wxgeQBkWkBxWv9NcgWMeRaRfC6gW7qBA?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet8_CropLand.pt  https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/Eeq1M8pXkWpOlF1c6DCK5vEByzA1E8gNFH6SRzSyrW-Zrw?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet32_CropLand.pt https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/EbT77UrkJI1JsDOV9aKfLckBkiRXJ8SxXySYCKgTwpbPgg?download=1")
  os.system("aria2c -x 8 -d {ModelPath} -o OctaveNet64_CropLand.pt https://emailkntuacir-my.sharepoint.com/:u:/g/personal/farhadinima75_email_kntu_ac_ir/EQodTpsz3_BMrgbaIlkeg8UBZ-i3S-ltAdLn__ZfgF49-g?download=1")
  print('Done.')
...
def Test(DatasetDir, LoadStateDictPath, Dims, OptionalName,
  ...
  ReleaseMem(Device)
  print(f'Predicted change map and color-coded comparision is located in:            {ModelDir}/{ModelName}')
  print(f'Also a zip file is created to download the whole output in a single file:  {ZipFile}')
  print(f'All Metrics are saved in:                                                  {f"{ModelDir}/TestMetrics.txt"}')
  print(f'For {ModelName}  Acc: {Metrics[0]*100:.2f}  Kappa: {Metrics[1]*100:.2f}  IoU: {Metrics[2]*100:.2f}  F1: {Metrics[3]*100:.2f}  Precision: {Metrics[4]*100:.2f}  Recall: {Metrics[5]*100:.2f}')
  print('#####################################################')
  print('#####################################################')
